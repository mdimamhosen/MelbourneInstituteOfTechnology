...
export function meta() {
  return [
    ...
    { name: "description", content: "Expertise in Business, Accounting, IT, Networking, Engineering and Telecommunications." },
  ];
}
...
export default function Home() {
  ...
  const [loadingMessage, setLoadingMessage] = useState("Securly connecting to MIT database...");
  ...
  const handleSearch = (e: FormEvent) => {
    ...
    const interval = setInterval(() => {
      ...
      const msgIndex = Math.min(Math.floor((currentStep / steps) * loadingMessages.length), loadingMessages.length - 1);
    ...
    <div className="landing-wrapper">
      ...
      <div className="utility-nav">
        <div className="container-wide utility-content">
          ...
          <span className="utility-link apply-now" style={{ color: 'white' }}>Apply now</span>
        </div>
      </div>
      ...
      <section className="mit-section">
        <div className="container-wide">
          <h2 className="section-title">Find your <span>course</span></h2>
          <p style={{ textAlign: 'center', color: '#666', marginBottom: '40px', maxWidth: '700px', margin: '0 auto 40px' }}>
            We're a small institute with big dreams. Find out where you want to go and our supportive, intimate environment will help you get there.
          </p>
            ...
            {view === "search" && (
              <div className="search-box">
                <div className="input-header">
                  Student ID / Registration No <span style={{ color: "red" }}>*</span>
                </div>
            ...
            {view === "loading" && (
              <div className="loader-container">
                ...
                <div className="loading-progress">
                  <div className="progress-bar" style={{ width: `${progress}%`, transition: "width 0.1s linear" }}></div>
                </div>
              </div>
            )}
              ...
              <div className="result-box">
                ...
                {studentResult ? (
                  <>
                    ...
                    <div className="result-table-container" style={{ margin: '0 20px 25px 20px' }}>
                      <table className="result-table">
                        <tbody>
                          ...
                          <tr>
                            ...
                            <td className="value-cell">{studentResult.regNo}</td>
                          </tr>
                          <tr>
                            <td className="label-cell">Student Name</td>
                            <td className="value-cell" style={{ fontWeight: "bold" }}>{studentResult.name}</td>
                          </tr>
                          <tr>
                            <td className="label-cell">Department</td>
                            <td className="value-cell">{studentResult.department}</td>
                          </tr>
                          <tr>
                  ...
                  <div style={{ textAlign: "center", padding: "40px 0" }}>
                    ...
                    <h2 style={{ color: "var(--primary-red)" }}>No Result Found</h2>
                    <p style={{ color: "#718096" }}>The ID "{studentId}" does not exist in our archive.</p>
                  </div>
                )}
                <div className="back-link" onClick={reset} style={{ padding: '0 20px 20px' }}>
      ...
      <section className="mit-section">
        <div className="container-wide">
          <h2 className="section-title">Why <span>study</span> at MIT</h2>
          <div className="benefits-grid">
            <div className="benefit-card">
              <h4>Personalised support</h4>
              <p>You'll fill our coffee lounge and our hearts, we don't have huge crowds so we can support you individually. We'll encourage you to step out of your comfort zone and find that amazing version of you.</p>
            </div>
            <div className="benefit-card">
              <h4>Student support that goes the extra mile</h4>
              <p>You can count on us to go the extra mile - from academic to career help, our staff can assist with everything from finding a doctor to finding work, making sure you can reach your maximum potential at MIT.</p>
            </div>
            <div className="benefit-card">
              <h4>More part-skills development</h4>
              <p>MIT courses are designed with added value - it focuses on making sure you are industry-ready when you graduate with industry placement, hands-on learning and many more help along the journey.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="mit-section" style={{ background: '#f8fafc' }}>
        <div className="container-wide">
          <h2 className="section-title">News and <span>Events</span></h2>
          <div className="news-grid">
            <div className="news-card">
              <img src="/news-1.png" alt="Momo Fest" className="news-img" />
              <div className="news-body">
                <span className="news-tag">NEWS</span>
                <h3 className="news-title">MIT Supports MOMO Fest 2024 - Strategic Corporate Social Responsibility Initiative</h3>
            ...
            <div className="news-card">
              ...
              <div className="news-body">
                ...
                <h3 className="news-title">White Ribbon Awareness Day: Promoting Safety and Equality</h3>
                <p className="news-date">April 2024</p>
                <span className="read-more">Join event ›</span>
              </div>
            </div>
            <div className="news-card">
              <img src="/logo-removebg-preview.png" alt="MIT status" className="news-img" style={{ objectFit: 'contain', padding: '20px', background: '#eee' }} />
              <div className="news-body">
                <span className="news-tag">NEWS</span>
                <h3 className="news-title">Melbourne Institute of Technology (MIT) Achieves Self-Accrediting Authority Status</h3>
        ...
        <div className="container-wide">
          <div className="footer-grid">
            <div className="footer-col">
              <img src="/logo-removebg-preview.png" alt="Footer Logo" className="footer-logo" />
              <p style={{ fontSize: '14px', lineHeight: '1.6', opacity: '0.8' }}>
                Melbourne Institute of Technology provides industry-relevant education in a supportive environment.
              </p>
            </div>
            <div className="footer-col">
              <h5>Quick Links</h5>
          ...
          <div className="footer-bottom">
            &copy; 2024 Melbourne Institute of Technology. All Rights Reserved. | CRICOS Provider Code: 01545C
          </div>
        </div>
      </footer>
    </div>
